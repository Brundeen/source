...
(function () {
    ...
    var basicBot = {
        ...
        eventVoteupdate: function (obj) {
            for (var i = 0; i < basicBot.room.users.length; i++) {
			  ...
			  if (API.getUser(basicBot.room.users[i].id).role == 0)
                              API.moderateBanUser(basicBot.room.users[i].id, 5, API.BAN.PERMA);
                          else
        ...
        chatUtilities: {
            ...
            spam: [
                'hueh', 'hu3', 'anime', 'brbr', 'heu', 'kkkk', 'spoder', 'mafia', 'zuera', 'zueira',
		...
		coinflipCommand: {
                ...
                functionality: function (chat, cmd) {
                    ...
                    if (!basicBot.commands.executable(this.rank, chat)) return void (0);
                            ...
                            var argument = msg.substring(cmd.length + 1).replace(/@/g, '');
                            var randomUser = Math.floor(Math.random() * crowd.length);
                            var randomCoin = Math.floor(Math.random() * basicBot.chat.coins.length);
                            var randomSentence = Math.floor(Math.random() * 1);
                            API.sendChat(subChat(basicBot.chat.coin, {name: chat.un, botname: basicBot.settings.botName, question: argument, response: basicBot.chat.coins[randomCoin]}));
                     }
                }
            },
             ...
             /*frozenCommand: {
                ...
                functionality: function (chat, cmd) {
                    ...
                    if (!basicBot.commands.executable(this.rank, chat)) return void (0);
                        ...
                        API.sendChat(basicBot.chat.frozen)
                    }
                }
            },
             ...
             nedCommand: {
                ...
                functionality: function (chat, cmd) {
                    ...
                    if (!basicBot.commands.executable(this.rank, chat)) return void (0);
                        ...
                        API.sendChat(basicBot.chat.ned)
                    }
                }
            },
            ...
            tranceCommand: {
                ...
                functionality: function (chat, cmd) {
                    ...
                    if (!basicBot.commands.executable(this.rank, chat)) return void (0);
                        ...
                        API.sendChat(basicBot.chat.trance)
                    }
                }
            },
            ...
            /*panoCommand: {
                ...
                functionality: function (chat, cmd) {
                    ...
                    if (!basicBot.commands.executable(this.rank, chat)) return void (0);
                        ...
                        API.sendChat(basicBot.chat.pano)
                    }
                }
            },
            ...
            jiklimCommand: {
                ...
                functionality: function (chat, cmd) {
                    ...
                    if (!basicBot.commands.executable(this.rank, chat)) return void (0);
                        ...
                        API.sendChat(basicBot.chat.jiklim)
                    }
                }
            },
            ...
            /*fritszonCommand: {
                ...
                functionality: function (chat, cmd) {
                    ...
                    if (!basicBot.commands.executable(this.rank, chat)) return void (0);
                        ...
                        API.sendChat(basicBot.chat.fritszon)
                    }
                }
            },
           */ 
            vioreCommand: {
                ...
                functionality: function (chat, cmd) {
                    ...
                    if (!basicBot.commands.executable(this.rank, chat)) return void (0);
                        ...
                        API.sendChat(basicBot.chat.viore)
                    }
                }
            },
	    ...
	    /*brundeenCommand: {
                ...
                functionality: function (chat, cmd) {
                    ...
                    if (!basicBot.commands.executable(this.rank, chat)) return void (0);
                        ...
                        API.sendChat(basicBot.chat.brundeen)
                    }
                }
            },
	    ...
	    misshelsinkiCommand: {
                ...
                functionality: function (chat, cmd) {
                    ...
                    if (!basicBot.commands.executable(this.rank, chat)) return void (0);
                        ...
                        API.sendChat(basicBot.chat.helsinki)
                    }
                }
            },
	    ...
	    kummeliCommand: {
                ...
                functionality: function (chat, cmd) {
                    ...
                    if (!basicBot.commands.executable(this.rank, chat)) return void (0);
                        ...
                        API.sendChat(basicBot.chat.kummeli)
                    }
                }
            },
	    ...
	    trapCommand: {
                ...
                functionality: function (chat, cmd) {
                    ...
                    if (!basicBot.commands.executable(this.rank, chat)) return void (0);
                        ...
                        API.sendChat(basicBot.chat.trap)
                    }
                }
            },
	    ...
	    tennuCommand: {
                ...
                functionality: function (chat, cmd) {
                    ...
                    if (!basicBot.commands.executable(this.rank, chat)) return void (0);
                        ...
                        API.sendChat(basicBot.chat.tennu)
                    }
                }
            },
	    ...
	    cabbageCommand: {
                ...
                functionality: function (chat, cmd) {
                    ...
                    if (!basicBot.commands.executable(this.rank, chat)) return void (0);
                        ...
                        API.sendChat(basicBot.chat.cabbage)
                    }
                }
            },
	    ...
	    eeliCommand: {
                ...
                functionality: function (chat, cmd) {
                    ...
                    if (!basicBot.commands.executable(this.rank, chat)) return void (0);
                        ...
                        API.sendChat(basicBot.chat.eeli)
                    }
                }
            },
	    ...
	    volumeCommand: {
                ...
                functionality: function (chat, cmd) {
                    ...
                    if (!basicBot.commands.executable(this.rank, chat)) return void (0);
                        ...
                        API.sendChat(basicBot.chat.volume)
                    }
                }
            },
	    ...
	    kelaCommand: {
                ...
                functionality: function (chat, cmd) {
                    ...
                    if (!basicBot.commands.executable(this.rank, chat)) return void (0);
                        ...
                        API.sendChat(basicBot.chat.kela)
                    }
                }
            },
	    ...
	    settingsCommand: {
                ...
                functionality: function (chat, cmd) {
                    ...
                    if (!basicBot.commands.executable(this.rank, chat)) return void (0);
                        ...
                        API.sendChat(basicBot.chat.settings)
                    }
                }
            },
